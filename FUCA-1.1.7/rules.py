...
def Rules(simul, n):
    ...
    # Alternative to 4
    if 6 in n:
        if simul.things.Pop <= 100:
            METABOLIC_ACTIVITY_CONSTANT = 0.1
        elif 100 < simul.things.Pop <= 200:
            METABOLIC_ACTIVITY_CONSTANT = 0.01 * (simul.things.Pop - 100)
        elif 200 < simul.things.Pop:
            METABOLIC_ACTIVITY_CONSTANT = 0.1 * (simul.things.Pop - 200)
